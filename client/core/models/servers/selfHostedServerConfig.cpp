...
SelfHostedServerConfig::SelfHostedServerConfig() : ServerConfig()
{
    type = ServerConfigType::SelfHosted;
}
...
SelfHostedServerConfig::SelfHostedServerConfig(const SelfHostedServerConfig &other)
    : ServerConfig(other),
      name(other.name),
      serverCredentials(other.serverCredentials)
{
}
