...
QString amnezia::scriptFolder(amnezia::DockerContainer container)
{
    ...
    case DockerContainer::V2RayTrojan: return QLatin1String("openvpn_v2ray_trojan");
...
QString amnezia::scriptName(ProtocolScriptType type)
{
    ...
    case ProtocolScriptType::v2ray_trojan_client_template: return QLatin1String("template_v2ray_trojan_client.json");
