...
ErrorCode WireguardProtocol::startMzImpl() {
    ...
    vpnConfigData[config_key::hostName] =
            NetworkUtilities::getIPAddress(vpnConfigData.value(config_key::hostName).toString());
...
ErrorCode WireguardProtocol::start() { return startMzImpl(); }
