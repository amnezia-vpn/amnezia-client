        ...
        footer: ColumnLayout {
            ...
            ParagraphTextType {
                ...
                text: {
                    ...
                    return text.replace("%1", LanguageUiController.getCurrentSiteUrl("free")).replace("/free", "") // todo link should come from gateway
                }
            ...
            BasicButtonType {
                ...
                clickedFunc: function() {
                    ...
                    var result = SubscriptionUiController.importService()
            ...
            ParagraphTextType {
                ...
                text: {
                    ...
                    var privacyUrl = LanguageUiController.getCurrentSiteUrl("policy")
