    ...
    ListViewType {
        ...
        header: ColumnLayout {
            ...
            BaseHeaderType {
                ...
                headerText: qsTr("Setup Multihop (Entry Node)")
            }
        }
        ...
        footer: ColumnLayout {
            ...
            BasicButtonType {
                ...
                clickedFunc: function() {
                    ...
                    InstallController.setupMultihopEntryNode(ServersUiController.processedServerId, _hostname, _username, _secretData, 51820)
