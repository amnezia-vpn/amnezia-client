...
RadioButton {
    ...
    property string selectedColor: FBLinkStyle.color.transparent

    property string textColor: FBLinkStyle.color.paleGray
    property string textDisabledColor: FBLinkStyle.color.mutedGray
    property string selectedTextColor: FBLinkStyle.color.goldenApricot
    property string selectedTextDisabledColor: FBLinkStyle.color.burntOrange
    ...
    indicator: Rectangle {
        ...
        border.color: root.focus ? root.borderFocusedColor : FBLinkStyle.color.transparent
