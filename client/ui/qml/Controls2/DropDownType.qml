...
Item {
    ...
    property string rootButtonImageColor: FBLinkStyle.color.paleGray
    property string rootButtonBackgroundColor: FBLinkStyle.color.onyxBlack
    property string rootButtonBackgroundHoveredColor: FBLinkStyle.color.onyxBlack
    property string rootButtonBackgroundPressedColor: FBLinkStyle.color.onyxBlack

    property string borderFocusedColor: FBLinkStyle.color.paleGray
    property int borderFocusedWidth: 1

    property string rootButtonHoveredBorderColor: FBLinkStyle.color.charcoalGray
    property string rootButtonDefaultBorderColor: FBLinkStyle.color.slateGray
    property string rootButtonPressedBorderColor: FBLinkStyle.color.paleGray
        ...
        Rectangle {
            ...
            color: {
                if (root.enabled) {
                    ...
                    return FBLinkStyle.color.transparent
                }
            }
