...
RadioButton {
    ...
    property string pressedBorderColor: FBLinkStyle.color.softGoldenApricot
    property string selectedBorderColor: FBLinkStyle.color.goldenApricot
    property string defaultBodredColor: FBLinkStyle.color.transparent
    property string focusBorderColor: FBLinkStyle.color.paleGray
