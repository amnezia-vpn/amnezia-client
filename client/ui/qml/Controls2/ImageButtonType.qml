...
Button {
    ...
    property string hoveredColor: FBLinkStyle.color.translucentWhite
    property string defaultColor: FBLinkStyle.color.transparent
    property string pressedColor: FBLinkStyle.color.sheerWhite
    property string disableColor: FBLinkStyle.color.slateGray

    property string imageColor: FBLinkStyle.color.mutedGray
    property string disableImageColor: FBLinkStyle.color.slateGray
