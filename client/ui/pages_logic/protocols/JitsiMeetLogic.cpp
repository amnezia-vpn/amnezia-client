...
JitsiMeetLogic::JitsiMeetLogic(UiLogic *logic, QObject *parent):
      PageProtocolLogicBase(logic, parent),
      m_lineJitsiMeetPortText{},
      m_lineAdminUserText{},
...
void JitsiMeetLogic::updateProtocolPage(const QJsonObject &jitsiConfig, DockerContainer container, bool haveAuthData)
{
...
QJsonObject JitsiMeetLogic::getProtocolConfigFromPage(QJsonObject oldConfig)
{
...
void JitsiMeetLogic::onPushButtonSaveClicked()
{
    QJsonObject protocolConfig = m_settings->protocolConfig(uiLogic()->m_selectedServerIndex, uiLogic()->m_selectedDockerContainer, Proto::JitsiMeet);
    ...
    newContainerConfig.insert(ProtocolProps::protoToString(Proto::JitsiMeet), protocolConfig);
    /*
...
void JitsiMeetLogic::onPushButtonCancelClicked()
{
