...
QString ServersModel::getServerId(const int serverIndex)
{
    return data(serverIndex, ServerIdRole).toString();
}

QString ServersModel::getProcessedServerId()
{
    return data(m_processedServerIndex, ServerIdRole).toString();
}

bool ServersModel::processedServerIsPremium()
{
    return data(m_processedServerIndex, IsPremiumRole).toBool();
}
