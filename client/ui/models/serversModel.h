...
class ServersModel : public QAbstractListModel
{
    ...
    Q_PROPERTY(QString processedServerId READ getProcessedServerId NOTIFY processedServerChanged)
...
public slots:
    ...
    QString getServerId(const int serverIndex);
    QString getProcessedServerId();
    bool processedServerIsPremium();
