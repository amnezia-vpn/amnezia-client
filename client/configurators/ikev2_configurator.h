...
class Ikev2Configurator : public ConfiguratorBase
{
    Q_OBJECT
public:
    Ikev2Configurator(std::shared_ptr<Settings> settings, const QSharedPointer<ServerController> &serverController,
    ...
    ConnectionData prepareIkev2Config(const ServerCredentials &serverCredentials, const ContainerConfig &containerConfig, ErrorCode &errorCode);
};
