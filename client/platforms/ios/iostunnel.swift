...
class PacketTunnelProvider: NEPacketTunnelProvider {private lazy var wgAdapter: WireGuardAdapter = {
    ...
    private var splitTunnelType: String?
    private var splitTunnelSites: String?
