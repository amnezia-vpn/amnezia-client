...
if(NOT CLIENT_MACOS_MEDIA_ASSETS_PATH)
    set(CLIENT_MACOS_MEDIA_ASSETS_PATH "${CMAKE_CURRENT_LIST_DIR}/../macos/app/Images.xcassets" CACHE FILEPATH "macOS app Images.xcassets path")
endif()
if(NOT CLIENT_MACOS_APP_ICNS_PATH)
    set(CLIENT_MACOS_APP_ICNS_PATH "${CMAKE_CURRENT_LIST_DIR}/../images/app.icns" CACHE FILEPATH "macOS app icon (.icns) used by non-App Store builds")
endif()
