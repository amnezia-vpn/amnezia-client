...
if(NOT DEFINED BUILD_IOS_NETWORK_EXTENSION)
    set(BUILD_IOS_NETWORK_EXTENSION ON)
endif()

if(BUILD_IOS_NETWORK_EXTENSION)
    set(IOS_SUPPORTED_PLATFORMS "iphoneos")
else()
    set(IOS_SUPPORTED_PLATFORMS "iphonesimulator iphoneos")
endif()
...
set_target_properties(${PROJECT} PROPERTIES
    ...
    XCODE_ATTRIBUTE_SUPPORTED_PLATFORMS "${IOS_SUPPORTED_PLATFORMS}"
