...
option(AMNEZIA_SDK_FROM_SOURCE "Build amnezia-sdk from source (debuggable) instead of the Conan package" ON)
if(AMNEZIA_SDK_FROM_SOURCE)
    message(STATUS "amnezia-sdk: building FROM SOURCE (add_subdirectory) — debuggable")
    add_subdirectory(${CMAKE_SOURCE_DIR}/amnezia-sdk ${CMAKE_BINARY_DIR}/amnezia-sdk)
    list(APPEND LIBS amnezia-sdk::amnezia-sdk)
else()
    message(STATUS "amnezia-sdk: consuming Conan package")
