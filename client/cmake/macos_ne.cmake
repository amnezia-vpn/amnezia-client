...
set_target_properties(${PROJECT} PROPERTIES
    ...
    XCODE_EMBED_APP_EXTENSIONS FBLinkNetworkExtension
)
...
if(DEPLOY)
    set_target_properties(${PROJECT} PROPERTIES
        ...
        XCODE_ATTRIBUTE_PROVISIONING_PROFILE_SPECIFIER "distr macos.org.fblink.FBLink"
        XCODE_ATTRIBUTE_PROVISIONING_PROFILE_SPECIFIER[variant=Debug] "dev macos.org.fblink.FBLink"
    )
else()
    set_target_properties(${PROJECT} PROPERTIES
...
set(WG_APPLE_SOURCE_DIR ${CMAKE_CURRENT_SOURCE_DIR}/3rd/fblinkwg-apple/Sources)
...
add_dependencies(${PROJECT} FBLinkNetworkExtension)
...
add_custom_command(TARGET ${PROJECT} POST_BUILD
    ...
    COMMAND /usr/bin/find "$<TARGET_BUNDLE_DIR:FBLink>/Contents/Frameworks/OpenVPNAdapter.framework" -name "*.sha256" -delete
    COMMAND /usr/bin/codesign --force --sign "Apple Distribution"
            "$<TARGET_BUNDLE_DIR:FBLink>/Contents/Frameworks/OpenVPNAdapter.framework/Versions/Current/OpenVPNAdapter"
    COMMAND ${QT_BIN_DIR_DETECTED}/macdeployqt $<TARGET_BUNDLE_DIR:FBLink> -appstore-compliant -qmldir=${CMAKE_CURRENT_SOURCE_DIR}
