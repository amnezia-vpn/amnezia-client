...
void Migrations::migrateV3()
{
    ...
    QString packageName = "org.fblink.vpn";
    ...
    QString location = rootLocation + "/files/.config/FBLink.ORG/FBLink.conf";
    ...
    if (oldConfig.exists()) {
        ...
        QFile newConfigFile(newConfigPath + "/FBLink.conf");
