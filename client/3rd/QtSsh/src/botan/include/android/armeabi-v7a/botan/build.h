...
* 'configure.py --os=android --cc=clang --cpu=arm'
*
* Target
*  - Compiler: /home/md/Android/Sdk/ndk/21.3.6528147/toolchains/llvm/prebuilt/linux-x86_64/bin/armv7a-linux-androideabi24-clang++ -fstack-protector -pthread -std=c++11 -D_REENTRANT -O3
*  - Arch: arm32
*  - OS: android
*/
