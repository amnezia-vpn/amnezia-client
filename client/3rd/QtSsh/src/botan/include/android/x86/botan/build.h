...
* 'configure.py --os=android --cc=clang --cpu=x86_32'
*
* Target
*  - Compiler: /home/md/Android/Sdk/ndk/21.3.6528147/toolchains/llvm/prebuilt/linux-x86_64/bin/x86_64-linux-android24-clang++ -fstack-protector -m32 -pthread -std=c++11 -D_REENTRANT -O3
*  - Arch: x86_32
*  - OS: android
*/
