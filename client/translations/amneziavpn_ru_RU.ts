...
<TS version="2.1" language="ru_RU">
	...
	<context>
		...
		<message>
			...
			<translation>
				Старые ключи перестанут работать. Пожалуйста, используйте новый ключ для подключения.
	...
	<context>
		...
		<message>
			...
			<translation>
				REALITY — это инновационный протокол от разработчиков XRay, специально созданный для эффективного противодействия жесткой интернет-цензуре.
		...
		<message>
			...
			<translation>
				Shadowsocks основан на протоколе SOCKS5 и шифрует соединение алгоритмом AEAD. Он разработан так, чтобы быть малозаметным, однако не идентичен HTTPS, поэтому может распознаваться некоторыми системами DPI. В связи с ограниченной поддержкой в Amnezia, рекомендуем использовать протокол AmneziaWG.
		...
		<message>
			...
			<translation>
				Эта комбинация состоит из протокола OpenVPN и плагина Cloak, специально разработанных для защиты от блокировок.
				...
				* Использует протокол TCP на порту 443
			</translation>
		</message>
		<message>
			...
			<translation>
				WireGuard — современный и простой VPN-протокол, который обеспечивает стабильное соединение и высокую скорость передачи данных на любых устройствах. Он использует фиксированные настройки шифрования, имеет меньшую задержку и выше пропускную способность по сравнению с OpenVPN.
		...
		<message>
			...
			<translation>
				...
				* Работает по UDP (порты 500 и 4500)
			</translation>
		</message>
		<message>
			<source>
