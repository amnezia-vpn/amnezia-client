...
# ####################################################################
#
# LIB_PATH - are releative path to libraries of a deployed distribution.
# QML_PATH - are releative path to qml libraries of a deployed distribution.
...
# SYSTEM_LIB_PATH - are releative path to system libraries of a deployed distribution.
