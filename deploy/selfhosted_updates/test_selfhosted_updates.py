...
class SourceContractTests(unittest.TestCase):
    ...
    def test_android_apk_install_handoff_controls_auto_install_marker(self) -> None:
        ...
        self.assertIn("QTimer::singleShot(5000, m_coreController->m_updateUiController, &UpdateUiController::checkForUpdates);", signal_handlers)
    ...
    def test_selfhosted_publish_defaults_to_local_non_apple_platforms(self) -> None:
        ...
        freeze_workflow = (REPO_ROOT / ".github/workflows/upstream-release-freeze.yml").read_text(encoding="utf-8")
        ...
        self.assertIn('run_repo_build_sh --target android --sign --abi arm64-v8a --build "$build_dir"', local_release)
        ...
        self.assertIn("m_selfHostedUpdateBootstrapper->start();", core_controller)
