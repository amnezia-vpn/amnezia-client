...
elseif(APPLE AND NOT IOS AND NOT MACOS_NE)
    if(CMAKE_OSX_ARCHITECTURES STREQUAL "arm64")
        set(_AMNEZIA_MACOS_PACKAGE_ARCH "arm64")
    else()
        set(_AMNEZIA_MACOS_PACKAGE_ARCH "x64")
    endif()
    set(CPACK_PACKAGE_FILE_NAME "AmneziaVPN_${AMNEZIAVPN_VERSION}_macos_${_AMNEZIA_MACOS_PACKAGE_ARCH}")
